...
class ApiClient {
  ...
  async deleteClient(id: number): Promise<DeleteResponse> {
    const response = await this.client.delete<DeleteResponse>(`/api/clients/${id}`);
    return response.data;
  }

  async deleteAllClients(): Promise<DeleteResponse> {
    const response = await this.client.delete<DeleteResponse>('/api/clients');
    return response.data;
  }
  ...
  async deleteWorkEntry(id: number): Promise<DeleteResponse> {
    const response = await this.client.delete<DeleteResponse>(`/api/work-entries/${id}`);
    return response.data;
  }

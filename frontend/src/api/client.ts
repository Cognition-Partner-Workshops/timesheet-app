...
import { type CreateProjectRequest, type ProjectStatus, type UpdateProjectRequest } from '../types/api';
...
class ApiClient {
  ...
  // Project endpoints
  async getProjects(filters?: { clientId?: number; status?: ProjectStatus }) {

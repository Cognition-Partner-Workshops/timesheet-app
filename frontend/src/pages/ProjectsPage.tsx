...
const ProjectsPage: React.FC = () => {
  ...
  const createMutation = useMutation({
    mutationFn: (data: { name: string; description?: string; clientId?: number | null; status?: string; startDate?: string | null }) =>
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }: { id: number; data: { name?: string; description?: string; clientId?: number | null; status?: string; startDate?: string | null } }) =>
  ...
  const handleOpen = (project?: Project) => {
    if (project) {
      ...
      setFormData({ name: '', description: '', clientId: '', status: 'active', startDate: '' });
    }
    setError('');
    setOpen(true);
  };

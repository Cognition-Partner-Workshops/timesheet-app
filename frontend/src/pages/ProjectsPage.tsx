...
const ProjectsPage: React.FC = () => {
  ...
  const mutationOptions = (fallbackMessage: string, closeOnSuccess: boolean) => ({
    onSuccess: () => {
                ...
                projects.map((project) => {
                  ...
                  return (
                    <TableRow key={project.id}>
                      ...
                      <TableCell>
                        <Chip label={status?.label || project.status} color={status?.color} size="small" />
                      </TableCell>
                      <TableCell>
                        {project.description ? (
                          <Typography variant="body2" color="text.secondary">

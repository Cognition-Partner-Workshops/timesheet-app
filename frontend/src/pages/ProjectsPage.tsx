...
const ProjectsPage: React.FC = () => {
  ...
  const createMutation = useMutation({
    mutationFn: (projectData: { name: string; description?: string; clientId?: number | null; startDate?: string | null; endDate?: string | null; status?: 'active' | 'completed' | 'on-hold'; hourlyRate?: number | null }) =>
  ...
  const updateMutation = useMutation({
    mutationFn: ({ id, data }: { id: number; data: { name?: string; description?: string; clientId?: number | null; startDate?: string | null; endDate?: string | null; status?: 'active' | 'completed' | 'on-hold'; hourlyRate?: number | null } }) =>

...
const ProjectsPage: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const projectData = {
      ...
      clientId: formData.clientId && formData.clientId !== 0 ? formData.clientId : null,
            ...
            <DialogContent>
              ...
              <FormControl fullWidth margin="dense">
                ...
                <Select
                  ...
                  label="Client"
                  onChange={(e) => setFormData({ ...formData, clientId: Number(e.target.value) || null })}
                  disabled={createMutation.isPending || updateMutation.isPending}
                >

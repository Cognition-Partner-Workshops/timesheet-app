...
describe('Database Initialization', () => {
  ...
  describe('initializeDatabase', () => {
    ...
    test('should create indexes for performance', async () => {
      ...
      expect(
        queries.some((q) => q.includes('CREATE INDEX IF NOT EXISTS idx_clients_user_email')),
      ).toBe(true);
      expect(
        queries.some((q) => q.includes('CREATE INDEX IF NOT EXISTS idx_work_entries_client_id')),
      ).toBe(true);
      expect(
        queries.some((q) => q.includes('CREATE INDEX IF NOT EXISTS idx_work_entries_user_email')),
      ).toBe(true);
      expect(
        queries.some((q) => q.includes('CREATE INDEX IF NOT EXISTS idx_work_entries_date')),
      ).toBe(true);
    });

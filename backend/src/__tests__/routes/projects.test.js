...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    ...
    test('should create project with client assignment', async () => {
      ...
      const createdProject = { id: 1, ...newProject, description: null, client_name: 'Client A', start_date: null, created_at: '2024-01-01', updated_at: '2024-01-01' };

      // First get call checks client exists
    ...
    test('should return 400 if client_id references non-existent client', async () => {
      const newProject = { name: 'Bad Client Project', client_id: 999 };
  ...
  describe('PUT /api/projects/:id', () => {
    test('should update project with valid data', async () => {
      const updatedProject = { id: 1, name: 'Updated Project', description: 'Updated Desc', client_id: null, client_name: null, start_date: null, status: 'completed', created_at: '2024-01-01', updated_at: '2024-01-02' };

      // First get checks project exists
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 1 });
      });
      ...
      // Second get returns updated project
      mockDb.get.mockImplementationOnce((query, params, callback) => {
    ...
    test('should return 400 if updating with invalid client_id', async () => {
      ...
      // Second get checks client exists
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, null);
      });

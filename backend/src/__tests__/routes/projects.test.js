...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    test('should create new project with all fields', async () => {
      const newProject = { name: 'New Project', description: 'Project desc', clientId: 1, startDate: '2024-06-01', status: 'active' };
      const createdProject = { id: 1, name: 'New Project', description: 'Project desc', client_id: 1, start_date: '2024-06-01', status: 'active', client_name: 'Client A', created_at: '2024-01-01', updated_at: '2024-01-01' };

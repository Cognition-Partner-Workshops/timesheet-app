...
describe('Project Routes', () => {
  ...
  describe('GET /api/projects', () => {
    test('should return all projects for authenticated user', async () => {
      const mockProjects = [
        ...
        { id: 2, name: 'Project B', description: 'Desc B', client_id: null, client_name: null, start_date: '2024-02-01', status: 'on-hold', created_at: '2024-01-02', updated_at: '2024-01-02' }
      ];
  ...
  describe('POST /api/projects', () => {
    ...
    test('should create project with client assignment', async () => {
      ...
      const createdProject = { id: 2, name: 'Client Project', client_id: 1, client_name: 'Client A', start_date: '2024-06-01', status: 'active', created_at: '2024-01-01', updated_at: '2024-01-01' };
  ...
  describe('PUT /api/projects/:id', () => {
    test('should update project with valid data', async () => {
      const updatedProject = { id: 1, name: 'Updated Project', description: 'Updated', client_id: null, client_name: null, start_date: null, status: 'completed', created_at: '2024-01-01', updated_at: '2024-01-02' };

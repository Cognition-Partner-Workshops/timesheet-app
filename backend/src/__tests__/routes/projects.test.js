...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    ...
    test('should create project with client assignment', async () => {
      const newProject = { name: 'Client Project', client_id: 1, status: 'active' };
      ...
      // First get call verifies client exists
      ...
      // Second get call retrieves the created project
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, createdProject);
      });
    ...
    test('should return 400 when client_id references non-existent client', async () => {
      mockDb.get.mockImplementation((query, params, callback) => {
        callback(null, null);
      });
  ...
  describe('PUT /api/projects/:id', () => {
    ...
    test('should return 400 when updating client_id to non-existent client', async () => {
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 1 }); // Project exists
      });

...
describe('Project Routes', () => {
  ...
  describe('GET /api/projects', () => {
    test('should return all projects for authenticated user', async () => {
      const mockProjects = [
        { id: 1, name: 'Project A', description: 'Desc A', client_id: 1, status: 'active', start_date: '2024-01-01', client_name: 'Client A' },
        { id: 2, name: 'Project B', description: 'Desc B', client_id: null, status: 'on-hold', start_date: null, client_name: null }
      ];
  ...
  describe('GET /api/projects/:id', () => {
    test('should return specific project', async () => {
      const mockProject = { id: 1, name: 'Project A', description: 'Desc A', client_id: 1, status: 'active', start_date: '2024-01-01', client_name: 'Client A' };
  ...
  describe('POST /api/projects', () => {
    test('should create new project with valid data (no client)', async () => {
      const newProject = { name: 'New Project', description: 'New Desc', status: 'active' };
    ...
    test('should return 400 if client does not belong to user', async () => {
      const newProject = { name: 'New Project', clientId: 999 };
  ...
  describe('PUT /api/projects/:id', () => {
    test('should update project with valid data', async () => {
      const updatedProject = { id: 1, name: 'Updated Project', description: null, client_id: null, status: 'completed', start_date: null, client_name: null };
    ...
    test('should return 400 if client does not belong to user on update', async () => {
      // First call: project exists
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 1 });
      });

      // Second call: client not found
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, null);
      });

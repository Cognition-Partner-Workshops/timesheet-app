...
describe('Project Routes', () => {
  ...
  describe('GET /api/projects', () => {
    test('should return all projects for authenticated user', async () => {
      const mockProjects = [
        { id: 1, name: 'Project A', description: 'Desc A', client_name: 'Client A', status: 'active', created_at: '2024-01-01', updated_at: '2024-01-01' },
        { id: 2, name: 'Project B', description: 'Desc B', client_name: 'Client B', status: 'completed', created_at: '2024-01-02', updated_at: '2024-01-02' }
      ];
  ...
  describe('GET /api/projects/:id', () => {
    test('should return specific project', async () => {
      const mockProject = { id: 1, name: 'Project A', description: 'Desc A', client_name: 'Client A', status: 'active' };
  ...
  describe('POST /api/projects', () => {
    ...
    test('should return 400 for missing required fields - clientId', async () => {
      const response = await request(app)
        .post('/api/projects')
        .send({ name: 'Project', startDate: '2024-01-01', status: 'active' });

      expect(response.status).toBe(400);
    });

    test('should return 400 for missing required fields - startDate', async () => {
      const response = await request(app)
        .post('/api/projects')
    ...
    test('should return 400 for missing required fields - status', async () => {
      const response = await request(app)
        .post('/api/projects')
        .send({ name: 'Project', clientId: 1, startDate: '2024-01-01' });

...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    test('should create new project with valid data', async () => {
      const newProject = { name: 'New Project', description: 'New Description', clientId: 1, startDate: '2024-03-01', status: 'active' };
      const createdProject = { id: 1, name: 'New Project', description: 'New Description', client_id: 1, start_date: '2024-03-01', status: 'active', client_name: 'Client A', created_at: '2024-01-01', updated_at: '2024-01-01' };
    ...
    test('should create project with only name', async () => {
      const newProject = { name: 'Simple Project' };
      const createdProject = { id: 1, name: 'Simple Project', description: null, client_id: null, start_date: null, status: 'active' };

...
describe('Project Routes', () => {
  ...
  describe('GET /api/projects', () => {
    test('should return all projects for authenticated user', async () => {
      const mockProjects = [
        { id: 1, name: 'Project A', description: 'Desc A', client_id: 1, status: 'active', client_name: 'Client A' },
        { id: 2, name: 'Project B', description: 'Desc B', client_id: null, status: 'completed', client_name: null }
      ];
  ...
  describe('POST /api/projects', () => {
    test('should create new project with valid data', async () => {
      ...
      const createdProject = { id: 1, ...newProject, client_id: null, start_date: null, end_date: null, hourly_rate: null, created_at: '2024-01-01', updated_at: '2024-01-01', client_name: null };
    ...
    test('should create project with client assignment', async () => {
      ...
      const createdProject = { id: 1, name: 'Client Project', client_id: 1, status: 'active', client_name: 'Client A' };
  ...
  describe('PUT /api/projects/:id', () => {
    ...
    test('should update project with client assignment', async () => {
      ...
      // Second: check client belongs to user
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 2 });
      });
      ...
      // Third: return updated project
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 1, name: 'Project', client_id: 2, client_name: 'New Client' });
      });
    ...
    test('should return 400 when updated client does not belong to user', async () => {
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 1 }); // Project exists
      });

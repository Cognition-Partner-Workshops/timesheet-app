...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    test('should create new project with valid data', async () => {
      ...
      const createdProject = { id: 1, name: 'New Project', description: 'New Description', client_id: null, client_name: null, start_date: null, status: 'active', created_at: '2024-01-01', updated_at: '2024-01-01' };
    ...
    test('should create project with clientId after verifying client exists', async () => {
    ...
    test('should return 400 for invalid status value', async () => {
      const response = await request(app)
        .post('/api/projects')
        .send({ name: 'Test Project', status: 'invalid-status' });
  ...
  describe('Authentication', () => {
    test('should require authentication for all routes', async () => {
      // The mock already provides authentication, so we verify routes work with it
      mockDb.all.mockImplementation((query, params, callback) => {
        callback(null, []);
      });

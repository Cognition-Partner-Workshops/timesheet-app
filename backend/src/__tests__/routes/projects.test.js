...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    test('should create new project with valid data', async () => {
      ...
      const createdProject = { id: 1, name: 'New Project', description: 'Desc', client_id: 1, status: 'active', client_name: 'Client A' };
      ...
      // After insert: return created project
      mockDb.get.mockImplementationOnce((query, params, callback) => {
    ...
    test('should return 400 for missing required fields', async () => {
      const response = await request(app)
        .post('/api/projects')
        .send({ description: 'Missing name and clientId' });
    ...
    test('should return 400 for invalid status', async () => {
      const response = await request(app)
        .post('/api/projects')
        .send({ name: 'Test', clientId: 1, status: 'invalid' });
  ...
  describe('PUT /api/projects/:id', () => {
    ...
    test('should validate clientId when updating', async () => {
      // Project exists
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 1 });
      });

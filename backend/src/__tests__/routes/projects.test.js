...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    ...
    test('should create project with client assignment', async () => {
      ...
      const createdProject = { id: 1, name: 'Client Project', client_id: 1, client_name: 'Test Client', status: 'active' };
    ...
    test('should create project with all fields', async () => {
      const newProject = { name: 'Full Project', description: 'Full desc', clientId: 1, startDate: '2024-01-15', status: 'on-hold' };
      const createdProject = { id: 1, ...newProject, client_id: 1, client_name: 'Client A', created_at: '2024-01-01', updated_at: '2024-01-01' };
  ...
  describe('PUT /api/projects/:id', () => {
    ...
    test('should return 400 if new client not found during update', async () => {
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 1 }); // Project exists
      });

...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    test('should create new project with valid data', async () => {
      ...
      const createdProject = { id: 1, name: 'New Project', description: 'New Description', client_id: 1, start_date: '2024-01-01', status: 'active', created_at: '2024-01-01', updated_at: '2024-01-01' };
    ...
    test('should create project with only required name', async () => {
    ...
    test('should default status to active when omitted', async () => {
      ...
      mockDb.get.mockImplementation((query, params, callback) => {
        callback(null, { id: 1, name: 'P', status: 'active' });
      });

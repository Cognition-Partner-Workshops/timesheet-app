...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    ...
    test('should create project without description', async () => {
      const newProject = { name: 'Project Without Desc', clientId: 1, startDate: '2024-01-01' };
      const createdProject = { id: 1, name: 'Project Without Desc', description: null, client_id: 1, start_date: '2024-01-01', status: 'active' };
    ...
    test('should return 400 if client not found', async () => {
      ...
      const response = await request(app)
        .post('/api/projects')
        .send({ name: 'Test Project', clientId: 999, startDate: '2024-01-01' });
  ...
  describe('PUT /api/projects/:id', () => {
    ...
    test('should update project clientId and verify new client exists', async () => {
      // First get: project exists
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 1 });
      });

      // Second get: new client exists
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 2 });
      });
    ...
    test('should handle database error when verifying new client during update', async () => {
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 1 }); // Project exists
      });

      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(new Error('Database error'), null); // Error verifying client
      });

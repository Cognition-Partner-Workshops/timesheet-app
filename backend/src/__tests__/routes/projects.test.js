...
describe('Project Routes', () => {
  ...
  describe('GET /api/projects/:id', () => {
    test('should return specific project', async () => {
      const mockProject = { id: 1, name: 'Project A', description: 'Desc A', status: 'active' };
  ...
  describe('POST /api/projects', () => {
    test('should create new project with valid data', async () => {
      ...
      const createdProject = { id: 1, ...newProject, client_id: null, start_date: null, created_at: '2024-01-01', updated_at: '2024-01-01' };
    ...
    test('should create project with client assignment', async () => {
      const newProject = { name: 'Client Project', clientId: 1, startDate: '2024-06-01' };
    ...
    test('should return 400 for invalid start date', async () => {
      const response = await request(app)
        .post('/api/projects')
        .send({ name: 'Project', startDate: 'not-a-date' });
  ...
  describe('PUT /api/projects/:id', () => {
    ...
    test('should update multiple fields at once', async () => {
      const updatedProject = { id: 1, name: 'New Name', description: 'New Description', status: 'on-hold', start_date: '2024-03-01' };
      ...
      const response = await request(app)
        .put('/api/projects/1')
        .send({ name: 'New Name', description: 'New Description', status: 'on-hold', startDate: '2024-03-01' });

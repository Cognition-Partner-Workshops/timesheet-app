...
describe('Project Routes', () => {
  ...
  describe('POST /api/projects', () => {
    ...
    test('should create project with a valid client assignment', async () => {
      ...
      const createdProject = { id: 1, name: 'Client Project', client_id: 5, start_date: '2024-02-01', status: 'on-hold' };
    ...
    test('should return 400 when assigned client does not belong to user', async () => {
      ...
      const response = await request(app)
        .post('/api/projects')
        .send({ name: 'Orphan Project', clientId: 999 });
  ...
  describe('PUT /api/projects/:id', () => {
    ...
    test('should update client assignment after verifying ownership', async () => {
      const updatedProject = { id: 1, name: 'Project', client_id: 3 };
    ...
    test('should return 400 when reassigned client does not belong to user', async () => {
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 1 });
      });
      mockDb.get.mockImplementationOnce((query, params, callback) => {

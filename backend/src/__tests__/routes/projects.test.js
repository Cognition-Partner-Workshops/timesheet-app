...
describe('Project Routes', () => {
  ...
  describe('GET /api/projects', () => {
    test('should return all projects for authenticated user', async () => {
      const mockProjects = [
        ...
        { id: 2, name: 'Project B', description: 'Desc B', client_id: null, start_date: null, status: 'completed', client_name: null }
      ];
  ...
  describe('POST /api/projects', () => {
    test('should create new project without client', async () => {
    ...
    test('should create new project with client', async () => {
      const newProject = { name: 'New Project', client_id: 1, status: 'active' };
      const createdProject = { id: 1, ...newProject, description: null, start_date: null, client_name: 'Client A', created_at: '2024-01-01', updated_at: '2024-01-01' };
    ...
    test('should return 400 for invalid client_id', async () => {
      mockDb.get.mockImplementation((query, params, callback) => {
        callback(null, null);
      });
      ...
      const response = await request(app)
        .post('/api/projects')
        .send({ name: 'Test Project', client_id: 999 });
    ...
    test('should handle error verifying client', async () => {
      ...
      const response = await request(app)
        .post('/api/projects')
        .send({ name: 'Test Project', client_id: 1 });
  ...
  describe('PUT /api/projects/:id', () => {
    ...
    test('should update project client_id', async () => {
      mockDb.get.mockImplementationOnce((query, params, callback) => {
    ...
    test('should allow setting client_id to null', async () => {
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 1 });
      });
      ...
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 1, name: 'Project', client_id: null, client_name: null });
      });
    ...
    test('should return 400 for invalid client_id during update', async () => {
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 1 }); // project exists
      });
    ...
    test('should handle database error when verifying client during update', async () => {
      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(null, { id: 1 }); // project exists
      });

      mockDb.get.mockImplementationOnce((query, params, callback) => {
        callback(new Error('Database error'), null); // client check error
      });

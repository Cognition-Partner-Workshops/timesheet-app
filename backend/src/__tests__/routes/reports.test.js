...
describe('Report Routes', () => {
  ...
  describe('PDF Export Success Path', () => {
    ...
    test('should generate PDF with many entries', async () => {
      ...
      const mockWorkEntries = [];
      for (let i = 0; i < 10; i++) {
        mockWorkEntries.push({ hours: 2, description: `Work ${i}`, date: `2024-01-${String(i + 1).padStart(2, '0')}`, created_at: '2024-01-01' });
      }
    ...
    test('should generate PDF with entries at separator intervals', async () => {
      const mockClient = { id: 1, name: 'Test Client' };
      const mockWorkEntries = [];
      for (let i = 0; i < 5; i++) {
        mockWorkEntries.push({ hours: 1, description: `Work ${i}`, date: `2024-01-${String(i + 1).padStart(2, '0')}`, created_at: '2024-01-01' });
      }

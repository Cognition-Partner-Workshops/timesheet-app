  ...
  try {
    ...
    db.get(
      ...
      (err, row) => {
        ...
        const checkClientAndUpdate = (callback) => {
        ...
        checkClientAndUpdate(() => {
          ...
          if (value.budgetHours !== undefined) {
            updates.push('budget_hours = ?');
            values.push(value.budgetHours != null ? value.budgetHours : null);
          }
...
router.delete('/:id', (req, res) => {
  ...
  db.get(
    ...
    (err, row) => {
      ...
      // Nullify project_id on associated work entries, then delete the project
      db.run(

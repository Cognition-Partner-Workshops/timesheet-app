...
/**
 * Verifies client ownership and retrieves associated work entries.
 * Calls `callback(client, workEntries)` on success, or sends an
 * error response and returns early on failure.
 */

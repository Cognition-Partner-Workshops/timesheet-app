...
// Load the requested client and its work entries, optionally filtered by project
function loadClientEntries(req, res, columns, onData) {
...
function totalHoursOf(workEntries) {
...
router.get('/client/:clientId', (req, res) => {
  loadClientEntries(req, res, 'id, hours, description, date, created_at, updated_at', (client, workEntries) => {
    res.json({
      client: client,
      workEntries: workEntries,
      totalHours: totalHoursOf(workEntries),
...
router.get('/export/csv/:clientId', (req, res) => {
  loadClientEntries(req, res, 'hours, description, date, created_at', (client, workEntries) => {
...
router.get('/export/pdf/:clientId', (req, res) => {
  loadClientEntries(req, res, 'hours, description, date, created_at', (client, workEntries) => {
    ...
    doc.fontSize(14).text(`Total Hours: ${totalHoursOf(workEntries).toFixed(2)}`);

 ...
 *       400:
 *         description: Invalid client ID filter
 *       401:
 ...
 *     description: Returns a single work entry by ID.
 *     tags: [Work Entries]
 *     parameters:
 *       - in: path
 *         name: id
 ...
 *     description: Records a new work entry for a client. The client must belong to the authenticated user.
 *     tags: [Work Entries]
 *     requestBody:
 *       required: true
 *       content:
 *         application/json:
 *           schema:
 *             $ref: '#/components/schemas/CreateWorkEntryRequest'
 *     responses:
 *       201:
 ...
 *                   $ref: '#/components/schemas/WorkEntry'
 *       400:
 *         description: Client not found or does not belong to user
 *       401:
 *         description: Authentication required
 *       422:
 ...
 *     description: Updates an existing work entry. At least one field must be provided.
 *     tags: [Work Entries]
 *     parameters:
 *       - in: path
 *         name: id
 ...
 *         application/json:
 *           schema:
 *             $ref: '#/components/schemas/UpdateWorkEntryRequest'
 *     responses:
 *       200:
 ...
 *                   $ref: '#/components/schemas/WorkEntry'
 *       400:
 *         description: Invalid work entry ID or client not found
 *       401:
 *         description: Authentication required
 *       404:
 *         description: Work entry not found
 ...
 *     description: Deletes a specific work entry.
 *     tags: [Work Entries]
 *     parameters:
 *       - in: path
 *         name: id

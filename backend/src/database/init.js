...
const INDEXES = [
  ...
  'idx_projects_user_email ON projects (user_email)',
...
async function initializeDatabase() {
  ...
  return new Promise((resolve, reject) => {
    database.serialize(() => {
      TABLE_SCHEMAS.forEach(sql => database.run(sql));
      INDEXES.forEach(idx => database.run(`CREATE INDEX IF NOT EXISTS ${idx}`));

...
const TABLE_SCHEMAS = [
  ...
  `CREATE TABLE IF NOT EXISTS projects (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    name TEXT NOT NULL, description TEXT, client_id INTEGER, start_date DATE,
...
async function initializeDatabase() {
  ...
  return new Promise((resolve, reject) => {
    database.serialize(() => {
      TABLE_SCHEMAS.forEach(schema => database.run(schema));
      INDEX_DEFINITIONS.forEach(idx => database.run(idx));
